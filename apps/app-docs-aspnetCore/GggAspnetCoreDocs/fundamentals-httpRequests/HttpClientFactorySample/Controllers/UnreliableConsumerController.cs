...
namespace HttpClientFactorySample.Controllers
{
    public class UnreliableConsumerController : Controller
    {
        ...
        public async Task<IActionResult> UnreliableEndpointConsumer()
        {
            ...
            string url = Url.Action("UnreliableEndpoint", "ThirdParty");
            ...
            string status = await _unreliableEndpointCallerService.GetDataFromUnreliableEndpoint(uriBuilder.Uri.ToString());
